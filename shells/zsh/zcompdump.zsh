...
autoload -Uz _bootctl _busctl _curl _hostnamectl _journalctl \
            _kernel-install _localectl _loginctl _networkctl _pulseaudio \
            ...
            _systemd-tmpfiles _timedatectl _udevadm _vlc _cdr \
            _floppy _logical_volumes _lscfg _lsdev _lslv \
            _lspv _lsvg _object_classes _physical_volumes _smit \
            _volume_groups _bsdconfig _bsd_disks _bsdinstall _bsd_pkg \
            _chflags _csup _cu _cvsup _fbsd_architectures \
            _fbsd_device_types _fetch _file_flags _freebsd-update _fstat \
            _fw_update _gstat _jail _jails _jexec \
            _jls _jot _kld _ldap _mixerctl \
            _nbsd_architectures _obsd_architectures _pfctl _pkgin _portaudit \
            _portlint _portmaster _portsnap _powerd _procstat \
            _rcctl _signify _sockstat _sysrc _systat \
            ...
            _networkmanager _opkg _pidof _pkgtool _pmap \
            ...
            _zsh-mime-handler _zsocket _zstyle _ztodo _hwinfo \
            _osc _SUSEconfig _yast _zypper
