...
alias gdc='git diff --color=always -w --cached'
alias gdh='git diff --color=always -w HEAD'
alias gdiff='git diff --color=always -w HEAD'
alias gds='git diff --color=always -w --staged'
